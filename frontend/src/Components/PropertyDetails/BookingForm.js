...
const BookingForm = ({
  ...
  const handleBookPlace = (e) => {
    ...
    if(
      ...
      dispatch(setPaymentDetails({...paymentData,propertyName,address,maximumGuest}));
        ...
        <div className="payment-field">
          ...
          <div className="name-phoneno">
            ...
            <input
              ...
              minLength="3"
            />
            <br /> <label className="payment-labels">Phone Number:</label>
            <br />
            <input
              type="tel"
